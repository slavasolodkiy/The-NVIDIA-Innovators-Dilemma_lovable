...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ISBN: 9798235142671 (e-Book) · ISBN: 9798195009434 (Paperback) · DOI 10.6084/m9.figshare.32133316 · ASIN: B0GZ42SBNY · https://www.dram.gold" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "The NVIDIA Innovator's Dilemma" },
      { property: "og:description", content: "ISBN: 9798235142671 (e-Book) · ISBN: 9798195009434 (Paperback) · DOI 10.6084/m9.figshare.32133316 · ASIN: B0GZ42SBNY · https://www.dram.gold" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "The NVIDIA Innovator's Dilemma" },
      { name: "twitter:description", content: "ISBN: 9798235142671 (e-Book) · ISBN: 9798195009434 (Paperback) · DOI 10.6084/m9.figshare.32133316 · ASIN: B0GZ42SBNY · https://www.dram.gold" },
